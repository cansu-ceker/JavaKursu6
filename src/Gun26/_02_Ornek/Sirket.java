...
//1.yöntem: dırek mainden yazdırmak
...
//2.yöntem metod ıle cagırmak: main in altına metod yazdık oradan
...
//4. yol, public String toString() ten geldı Person classın ıcındekinden
        System.out.println("personel1 = " + personel1);    //sout personel1.toString(); de dıyebılırdık aynı sey- java kendı default olarak yazmasan da onu anlıyor baska bı calss ta adını toString li yaptıgın ıcın,
                                                          // buradan personelı cagırdın, personelın nesını ekrana yazsın ıstıyosan o classta belırttın o yuzden o belırtıklerımı dırekt bana yazdır demıs oluyorsun

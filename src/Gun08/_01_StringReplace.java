...
public class _01_StringReplace {
    public static void main(String[] args) {
        ...
        System.out.println("a ları e ile  değiştir = " + text.replace("a","e"));  //Merhebe Dünye  // a ları e yap
        ...
        System.out.println("a ları boşluk ' ' ile değiştir ="  + text.replace("a"," ")); // Merh b  Düny     a lar silindi

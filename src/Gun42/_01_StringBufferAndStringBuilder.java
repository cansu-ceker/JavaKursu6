...
public class _01_StringBufferAndStringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println("cumle.concat(\"dün değildi.\") = " + cumle.concat("  dün değildi."));  //cevap   Bugün hava çok soğuk değil mi dün değildi, ama halan aslında cumle degısmedı yıne ekleme yapmıs olduk

        cumle.concat(" merhaba"); // cümlenin değeri değişmez, atama gerektirir
        cumle=cumle.concat(" MERHABA");  // eşitleme var, cümlenin değeri değişir
